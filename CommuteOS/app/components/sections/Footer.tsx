...
const links = {
  Product: ["Features", "Routing Engine", "Mobile App", "Integrations", "Changelog"],
  Solutions: ["Enterprise", "Mid-size Companies", "IT Parks", "SEZs"],
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8 py-14 md:py-16">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 md:gap-10">
          ...
          <div className="col-span-2">
            ...
            <div className="mt-5 flex items-center gap-1.5 text-xs text-[#333]">
              <span className="w-1.5 h-1.5 rounded-full bg-[#4caf50] opacity-60" />
        ...
        <div className="mt-12 pt-6 border-t border-[#161616] flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-[#333]">
            © 2025 CommuteOS Technologies Pvt. Ltd. Bengaluru, India.
          </p>
